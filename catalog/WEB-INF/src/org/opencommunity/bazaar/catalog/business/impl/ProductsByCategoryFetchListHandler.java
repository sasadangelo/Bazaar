...
class ProductsByCategoryFetchListHandler implements IDataListHandler {
	...
	// finders
	ProductsByCategoryFetchListHandler(long nCategoryID, int pageLength) {
	...
	public IDataListChunk getListChunk() throws DataListException {
    	...
    	try {
    		...
    		size = dao.countProductsByCategory(nCategoryID);
    		list = dao.findByCategory(nCategoryID, startIndex, pageLength);
    		tm.commit();
