...
public class ActionRedirect extends ActionForward {
    ...
    /**
     * <p>The character encoding used for parameter values.</p> 
     */ 
    ...
    /**
     * <p>Adds a string parameter to the list of parameters.  Values
     * are URLEncoded to UTF-8 format.</p>
     *
    ...
    public void addParameter(String fieldName, String value) {
        ...
        try {
            value = URLEncoder.encode(value, CHAR_ENCODING);
    ...
    /**
     * <p>Adds a char parameter to the list of parameters.</p>
     *
     * @param fieldName the name to use for the parameter
     * @param value the value for this parameter
     */
    public void addParameter(String fieldName, char value) {
        addParameter(fieldName, String.valueOf(value));
    }

    /**
     * <p>Adds a short parameter to the list of parameters.</p>
     *
     * @param fieldName the name to use for the parameter
     * @param value the value for this parameter
     */
    public void addParameter(String fieldName, short value) {
        addParameter(fieldName, String.valueOf(value));
    }

    /**
     * <p>Adds an int parameter to the list of parameters.</p>
     *
     * @param fieldName the name to use for the parameter
     * @param value the value for this parameter
     */
    ...
    /**
     * <p>Adds a byte parameter to the list of parameters.</p>
     *
     * @param fieldName the name to use for the parameter
     * @param value the value for this parameter
     */
    public void addParameter(String fieldName, byte value) {
        addParameter(fieldName, String.valueOf(value));
    }

    /**
     * <p>Adds a long parameter to the list of parameters.</p>
     *
     * @param fieldName the name to use for the parameter
     * @param value the value for this parameter
     */
    public void addParameter(String fieldName, long value) {
        addParameter(fieldName, String.valueOf(value));
    }

    /**
     * <p>Adds a float parameter to the list of parameters.</p>
     *
     * @param fieldName the name to use for the parameter
     * @param value the value for this parameter
     */
    public void addParameter(String fieldName, float value) {
        addParameter(fieldName, String.valueOf(value));
    }

    /**
     * <p>Adds a double parameter to the list of parameters.</p>
     *
     * @param fieldName the name to use for the parameter
     * @param value the value for this parameter
     */
    ...
    /**
     * <p>Adds a boolean parameter to the list of parameters.</p>
     *
     * @param fieldName the name to use for the parameter
     * @param value the value for this parameter
     */
    public void addParameter(String fieldName, boolean value) {
        addParameter(fieldName, String.valueOf(value));
    }
    ...
    public void addParameter(String fieldName, Object value) {
        addParameter(fieldName, (value != null) ? value.toString() : "");
    }
