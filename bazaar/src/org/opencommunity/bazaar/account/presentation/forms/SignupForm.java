...
public final class SignupForm extends ValidatorForm {
	...
	/**
	 * @return Returns the bAgree.
	 */
	public boolean isBAgree() {
		return bAgree;
	}
	/**
	 * @param agree The bAgree to set.
	 */
	public void setBAgree(boolean agree) {
		bAgree = agree;
	}
}
